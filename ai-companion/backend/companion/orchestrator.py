...
class BackendOrchestrator:
    """Legacy coordinator that now embeds the DialogueOrchestrator."""
    ...
    def __init__(self, settings: CompanionSettings) -> None:
        ...
        logger.warning(
            "BackendOrchestrator is deprecated; using DialogueOrchestrator internally"
        )
    ...
    def decide(
        ...
        """Bridge to the DialogueOrchestrator decision logic."""

        return self.dialogue.decide(scene, lines, lang, emotion_hint, cooldown_ok)
